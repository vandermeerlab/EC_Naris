...
cfg_def.c_order_pow = [27 161 0; 64 155 191; 105 61 230]/255; % specific colours to match the histology markers in figure 1a
...
%         legend([h1(1), h2(1), h3(1)], 'R2', 'R4', 'R5', 'orientation', 'horizontal', 'fontsize', 16)
    ...
    legend([h1(1), h2(1), h3(1)],{'R2', 'R5', 'R6'}, 'location', 'northoutside', 'orientation', 'horizontal', 'fontsize', 16)
