...
cfg_def = [];
cfg_def.win = 512;
cfg_def.noverlab = cfg_def.win/4;
cfg_def.linewidth = 3;
...
[~,Fp,Tp,Pp] = spectrogram(naris.pre.data_ampx.channels{1},rectwin(1024),512,1:120,naris.pre.data_ampx.hdr.Fs);
[~,Fi,Ti,Pi] = spectrogram(naris.ipsi.data_ampx.channels{1},rectwin(1024),512,1:120,naris.ipsi.data_ampx.hdr.Fs);
[~,Fc,Tc,Pc] = spectrogram(naris.contra.data_ampx.channels{1},rectwin(1024),512,1:120,naris.contra.data_ampx.hdr.Fs);

[~,F,T,P] = spectrogram(all_naris.channels{1},rectwin(1024),512,1:120,all_naris.hdr.Fs);
