...
for iband = 1:5
    hold on
    if iband ==5
        plot3(Xscore.(bands{iband})(:,1),Xscore.(bands{iband})(:,2),Xscore.(bands{iband})(:,3),'o', 'MarkerFaceColor', c_ord(iband,:), 'MarkerEdgeColor', c_ord(iband,:), 'MarkerSize', 3)
    elseif iband == 3 || iband ==4
        plot3(Xscore.(bands{iband})(:,1),Xscore.(bands{iband})(:,2),Xscore.(bands{iband})(:,3),'+', 'MarkerFaceColor', c_ord(iband,:), 'MarkerEdgeColor', [.8 .8 .8], 'MarkerSize', 3)
    else
        plot3(Xscore.(bands{iband})(:,1),Xscore.(bands{iband})(:,2),Xscore.(bands{iband})(:,3),'o', 'MarkerFaceColor', c_ord(iband,:), 'MarkerEdgeColor', c_ord(iband,:), 'MarkerSize', 3)
    end
end
